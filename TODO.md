...
### S47: the cross-stable arb books an unmeasurable stable-pair spread as a FREE return leg
...
### S48: Dexie's `last` under CAT keys looks reciprocal -- BYC/wUSDC.b may ingest 0.48 instead of ~2.083 (PLAUSIBLE, unverified)
...
### S49: fair-value inputs have provenance (PR #159 Gate 1) but no recency
