...
| [trading-strategies.md](./trading-strategies.md) | Complete strategy catalog: 12 implemented, 5 considered, 21 future strategies — goals & KPIs, scholarly references (58), implementation priority ranking, key trade-offs with strategy-switching policy, competitive coexistence/order-book interaction guidance, Chia-specific advantages, and guidance on deliberate loss-taking and inventory balance |
| [CODE REVIEWS/COUNTERRESEARCH-20260325-1-GitHubCopilot-Claude-Sonnet-4.6.md](./CODE%20REVIEWS/COUNTERRESEARCH-20260325-1-GitHubCopilot-Claude-Sonnet-4.6.md) | Counter-academic research review: 12 challenge areas (3 HIGH, 6 MEDIUM, 3 LOW) against the 58 cited papers — identifies where counter-literature disputes XOPTrader's theoretical foundations, including challenges to VPIN, OFI, PIN, VR test power, Yang-Zhang, Thompson Sampling, A-S horizon design, and GLFT in sparse discrete markets |
