...
| [trading-strategies.md](./trading-strategies.md) | Complete strategy catalog: 12 implemented, 5 considered, 21 future strategies — goals & KPIs, scholarly references (42), implementation priority ranking, key trade-offs with strategy-switching policy, Chia-specific advantages, and guidance on deliberate loss-taking and inventory balance |
