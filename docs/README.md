...
| [advanced-trading-methods.md](./advanced-trading-methods.md) | VPIN flow-toxicity estimation, OFI order-flow imbalance, asymmetric spread widening — scholarly references; plus §4, the SVPerp market-making literature, the Bitfinex BVIV comparable, and which published methods can actually run on Permuto |
| [permuto-api-reference.md](./permuto-api-reference.md) | Permuto Capital perps API: the public and authenticated routes, the wallet-auth flow, and the band, funding and margin constraints that bind a market maker |
| [trading-strategies.md](./trading-strategies.md) | Complete strategy catalog: 12 implemented, 5 considered, 21 future strategies — goals & KPIs, scholarly references (67 including 16 counter-research), implementation priority ranking, key trade-offs with strategy-switching policy, competitive coexistence/order-book interaction guidance, Chia-specific advantages, strategy selection rationale with per-strategy confidence rankings (HIGH/MEDIUM/LOW) documenting why each approach was chosen despite academic disagreements, guidance on deliberate loss-taking and inventory balance, and circuit-breaker design with scholarly citations (§5.3) |
| [CODE REVIEWS/COUNTERRESEARCH-20260325-1-GitHubCopilot-Claude-Sonnet-4.6.md](./CODE%20REVIEWS/COUNTERRESEARCH-20260325-1-GitHubCopilot-Claude-Sonnet-4.6.md) | Counter-academic research review: 15 challenge areas (3 HIGH, 8 MEDIUM, 4 LOW) against the cited papers — identifies where counter-literature disputes XOPTrader's theoretical foundations, with inline code integration of all findings |
| [CODE REVIEWS/CODEREVIEW-20260413-GitHub-Copilot-GPT-5.4-Trade-Decision-Tree-Scenarios.md](./CODE%20REVIEWS/CODEREVIEW-20260413-GitHub-Copilot-GPT-5.4-Trade-Decision-Tree-Scenarios.md) | Trade trigger and block decision matrix for recovery, crossed-book arbitrage, and buyer, grouped with the midpoint and buyer code review set |
| [CODE REVIEWS/CODEREVIEW-20260413-GitHub-Copilot-GPT-5.4-Trade-Scenario-Observability-Map.md](./CODE%20REVIEWS/CODEREVIEW-20260413-GitHub-Copilot-GPT-5.4-Trade-Scenario-Observability-Map.md) | Maps each scenario ID to the exact engine log substring, current Prometheus signal, and observability gaps |
| [CODE REVIEWS/CODEREVIEW-20260413-GitHub-Copilot-GPT-5.4-Buyer-Operator-Runbook.md](./CODE%20REVIEWS/CODEREVIEW-20260413-GitHub-Copilot-GPT-5.4-Buyer-Operator-Runbook.md) | Short operator runbook for Step 9e buyer behavior, gates, fast triage, and safe enablement |
| [CODE REVIEWS/CODEREVIEW-20260413-GitHub-Copilot-GPT-5.4-Trade-Decision-Blackhole-Audit.md](./CODE%20REVIEWS/CODEREVIEW-20260413-GitHub-Copilot-GPT-5.4-Trade-Decision-Blackhole-Audit.md) | Reachability audit showing which decision endpoints are structurally impossible or mathematically dead under the current code and config |
